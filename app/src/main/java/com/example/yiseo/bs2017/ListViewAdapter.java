...
public class ListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView AuthorTextView = (TextView) convertView.findViewById(R.id.AuthorText) ;
        TextView PublisherTextView = (TextView) convertView.findViewById(R.id.PublisherText) ;
    ...
    public void addItem(String icon, String title, String author, String publisher) {
